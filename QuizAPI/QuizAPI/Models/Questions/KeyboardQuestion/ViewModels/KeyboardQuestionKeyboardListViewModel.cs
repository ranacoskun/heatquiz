...
{
    public class KeyboardQuestionKeyboardListViewModel : QuestionBaseViewModel
    {
        //Answer For In Latex
        ...
        public List<QuestionSeriesElementViewModel> SeriesElements { get; set; } = new List<QuestionSeriesElementViewModel>();
