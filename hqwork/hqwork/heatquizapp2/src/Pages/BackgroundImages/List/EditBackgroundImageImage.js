...
export function EditBackgroundImageImage({open, onClose, backgroundImage, reloadData}){

    if(!open) return <div/>;

    const [messageApi, contextHolder] = message.useMessage();

    const {isLoadingEditBackgroundImageImage, editBackgroundImageImage} = useDefaultValues()
            ...
            <Drawer
                ...
                footer={
                    <Space>
                        ...
                        <small className="default-title">{backgroundImage.Code}</small>
                    </Space>
                }
            >
                ...
                <Button 
                    ...
                    onClick={() => {
                        ...
                        editBackgroundImageImage(data).then((r) => 
                    ...
                    loading = {isLoadingEditBackgroundImageImage}
                >
                Update
                </Button>
            </Drawer>
