...
export function getStudentDashboardInfoRequest(b){
    return ADD_REQUEST_FILE_API('SimpleClickable/GetDashboardInfo', b)
}

export function getDashboardRandomQuestionsRequest(b){
    return ADD_REQUEST_FILE_API('SimpleClickable/GetRandomQuestionsDataPool', b)
}

export function getDashboardWorstPlayedQuestionsRequest(b){
    return ADD_REQUEST_FILE_API('SimpleClickable/GetWorstPlayedQuestionsDataPool', b)
}
