...
export function assignAudioToMapElementRequest(b){
    return ADD_REQUEST_FILE_API('CourseMap/AddEditElementAudio/', b, true)
}

export function removeAudioToMapElementRequest(b){
    return ADD_REQUEST_FILE_API('CourseMap/RemoveElementAudio/', b, true)
}
