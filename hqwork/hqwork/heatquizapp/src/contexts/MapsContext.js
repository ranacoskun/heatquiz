...
export function MapsProvider ({children}){
    ...
    const {loading: loadingAssignAudioToMapElement, value: assignAudioToMapElementResult, error: assignAudioToMapElementError, execute: assignAudioToMapElement} = useAsyncFn((b) => assignAudioToMapElementRequest(b))
    const {loading: loadingRemoveAudioToMapElement, value: removeAudioToMapElementResult, error: removeAudioToMapElementError, execute: removeAudioToMapElement} = useAsyncFn((b) => removeAudioToMapElementRequest(b))
    ...
    return(
        <Context.Provider value = {{
            ...
            loadingAssignAudioToMapElement,
            assignAudioToMapElementResult,
            assignAudioToMapElementError,
            assignAudioToMapElement,

            loadingRemoveAudioToMapElement,
            removeAudioToMapElementResult,
            removeAudioToMapElementError,
