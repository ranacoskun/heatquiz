...
export function AssistanceObjectsProvider ({children}){
    ...
    const {value: getStudentDashboardInfoResult, errorGetStudentDashboardInfo, loading:isLoadingGetStudentDashboardInfo, execute: getStudentDashboardInfo} = useAsyncFn((b) => getStudentDashboardInfoRequest(b))

    const {value: getDashboardRandomQuestionsResult, errorGetDashboardRandomQuestions, loading:isLoadingGetDashboardRandomQuestions, execute: getDashboardRandomQuestions} = useAsyncFn((b) => getDashboardRandomQuestionsRequest(b))
    const {value: getDashboardWorstPlayedQuestionsResult, errorGetDashboardWorstPlayedQuestions, loading:isLoadingGetDashboardWorstPlayedQuestions, execute: getDashboardWorstPlayedQuestions} = useAsyncFn((b) => getDashboardWorstPlayedQuestionsRequest(b))
    ...
    return(
        <Context.Provider value = {{
            ...
            getStudentDashboardInfoResult,
            errorGetStudentDashboardInfo,
            isLoadingGetStudentDashboardInfo,
            getStudentDashboardInfo,

            getDashboardRandomQuestionsResult,
            errorGetDashboardRandomQuestions,
            isLoadingGetDashboardRandomQuestions,
            getDashboardRandomQuestions,

            getDashboardWorstPlayedQuestionsResult,
            errorGetDashboardWorstPlayedQuestions,
            isLoadingGetDashboardWorstPlayedQuestions,
            getDashboardWorstPlayedQuestions
        }}>
            {children}
        </Context.Provider>
    )
