...
export function UpdateQuestionImage({open, onClose, question, reloadQuestion}){
    ...
    const {isLoadingEditEnergyBalanceImage, editEnergyBalanceImage,} = useQuestions()
    ...
    return(
        ...
        <Space size={'large'}>
            ...
            <Button
                ...
                loading={isLoadingEditEnergyBalanceImage}
                ...
                onClick={() => {
                    ...
                    editEnergyBalanceImage(data).then(r => handleResponse(r, api, 'Updated successfully', 1, () => {
                        reloadQuestion()
                        onClose()
                    })) 
