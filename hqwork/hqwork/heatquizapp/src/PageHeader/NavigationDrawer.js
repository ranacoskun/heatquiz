...
import {MenuOutlined, BuildTwoTone, SettingTwoTone, IdcardTwoTone, ContactsTwoTone, SnippetsTwoTone, BellTwoTone, SoundTwoTone,DatabaseTwoTone, ContainerTwoTone, FlagTwoTone, AppstoreTwoTone, ControlTwoTone, SlidersTwoTone, PlusSquareTwoTone, ExperimentTwoTone } from '@ant-design/icons';
...
const NavigationDrawer = () => {
    ...
    }, 
    {
        label:'AI Studio',
        key:'/aistudio',
        icon: <ExperimentTwoTone style={{...iconStyle}}/>
    },
    {
        label:'Courses',
        children:[
    ...
    },
    {
        ...
        },
        {
            ...
            label:'Questionnaire',
            key:'/add_questionnaire',
            icon:<PlusSquareTwoTone  style={{...iconStyle}}/>
        },{
            label:'Questionnaires list',
            key:'/questionnaires_list',
            icon:<DatabaseTwoTone  style={{...iconStyle}}/>
        }
        ],
        type:'group'
